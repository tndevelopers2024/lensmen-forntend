          ...
          displayCategories.map((cat, idx) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  {cat.imageUrl
                    ? <img src={cat.imageUrl} alt="" style={{ width: 36, height: 36, borderRadius: 8, objectFit: 'cover', border: '1px solid #f0f0f0' }} />
                    : <div style={{ width: 36, height: 36, borderRadius: 8, background: '#f3f4f6', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 11, color: '#9ca3af' }}>—</div>
                  }
                </div>
